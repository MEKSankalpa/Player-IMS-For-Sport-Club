               ...
               <?php
                 if (isset($_SESSION['auth'])) {
                   echo '<li class="nav-item dropdown mr-5 px-5">
                        <a href="" class="nav-link dropdown-toggle " data-toggle="dropdown" type="button" style="color:#a3a375;">  <?php echo $_SESSION["auth"]; ?> </a>
...
<?php
  if (!isset($_SESSION['auth'])) {
    echo '<p class="text-dark text-center bg-primary font-weight-bold font-size-md my-1">ITs Home!</p>';
  }else {
    echo '<div class="text-dark text-center bg-primary font-weight-bold font-size-md mt-1">I am in!</div>';
  }
 ?>
