...
<link rel="stylesheet" href="css/player.css">
     <div class="form-group  px-5 mt-4">
         <div class="img-profile mb-3" ><img src=" images/user.png" onclick="profileImgClick()" id="default" class="profileDisplay" alt="profile image" width="100" height="100" style="cursor:pointer;">
        </div>
        <label class="profile-label" for="pro_img">Profile Image</label>
